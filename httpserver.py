...
try:
    ...
    logging.getLogger('Licensing').critical(
        'Error getting list of source files! AGPL requires this. To fix, be '
        'sure you are using git for Eloipool.', exc_info=True)
    import sys
    sys.exit(1)

class AsyncRequest(Exception):
    pass
